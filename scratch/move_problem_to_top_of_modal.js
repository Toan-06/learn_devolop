...
console.log("📌 Moving Problem Statement (ĐỀ BÀI) unconditionally to the TOP of the sample viewer modal...");

const viewerPath = path.join(__dirname, '..', 'assets', 'sample_viewer.js');

const updatedViewerJs = `// ===== SAMPLE EXERCISES VIEWER SYSTEM (MOBILE OPTIMIZED) =====
...
fs.writeFileSync(viewerPath, updatedViewerJs, 'utf8');
console.log("✅ Moved ĐỀ BÀI / CÂU HỎI MẪU unconditionally to the VERY TOP of single sample modal!");
