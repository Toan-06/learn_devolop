...
const viewerContent = `// ===== SAMPLE EXERCISES VIEWER SYSTEM (DARK CYBER THEME) =====
...
fs.writeFileSync(path.join(__dirname, '..', 'assets', 'sample_viewer.js'), viewerContent, 'utf8');
console.log('✅ Successfully updated sample_viewer.js with English, Science, Social tabs!');
